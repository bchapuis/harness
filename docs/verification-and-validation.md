...
- **Membership (#14–#17, #19).** Convergence after partitions heal; `down` is terminal; a partition alone never downs a member; SWIM refutation via incarnation; receptionist pruned on node `down`.
